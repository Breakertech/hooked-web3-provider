    ...
    value: function rewritePayloads(index, requests, session_nonces, finished) {
      ...
      this.transaction_signer.hasAddress(sender, function (err, has_address) {
          ...
          if (nonce != null) {
            ...
            _this4.sendAsync({
              ...
              if (err != null) {
                ...
                done(null, _web2.default.prototype.toDecimal(new_nonce));
              }
            });
          }
        };
        ...
        getNonce(function (err, nonce) {
          ...
          tx_params.nonce = _web2.default.prototype.toHex(final_nonce);
...
}(_web2.default.providers.HttpProvider);

exports.default = HookedWeb3Provider;
